...
/*   Updated: 2020/06/02 09:39:09 by roalvare         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				*btree_search_item(t_btree *root, void*data,
					int(*cmpf)(void*, void*));
t_btree				*btree_search(t_btree *root, void *data,
					int(*cmpf)(void*, void*));
...
void				btree_insert_avl(t_btree **root, void *item,
					int (*cmpf)(void*, void*));
